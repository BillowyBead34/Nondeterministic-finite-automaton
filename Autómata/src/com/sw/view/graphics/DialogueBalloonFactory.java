...
import static com.sw.view.components.DialogueBalloon.RADIO_BORDER;
import static com.sw.view.components.DialogueBalloon.TRIANGLE_HEIGHT;
import static com.sw.view.components.DialogueBalloon.TRIANGLE_LENGTH;
...
public class DialogueBalloonFactory implements ShapeFactory {
    ...
    @Override public Shape createShape(int xPos, int yPos, int width, int height, Box.BoxPosition boxPosition) {
